  ...
  },
  {
    ...
    a: [
      ...
      },
      {
        ...
        type: ["싱가폴", "미국 캘리포니아", "스위스"],
      },
      {
        answer: "c. 어쨌든 같이왔으니 조금 싫은소리를 해서라도 일으켜세운다.",
        type: ["이스탄불", "스위스", "중국", "북극", "미국 뉴욕"],
      },
    ],
  },
  {
    ...
    a: [
      ...
      },
      {
        ...
        type: ["이집트 사막", "영국 런던", "보라카이", "이스탄불", "북극"],
      },
      {
        answer: "c. 다 필요없다. 모든건 사서쓰는게 최고다.",
        type: ["탄자니아 세렝게티", "캐나다 나이아가라 폭포", "태국"],
      },
    ],
  },
  {
    q: "5. 박물관에서 유명한 작품을 보고있다. 지금 드는 생각은?",
    a: [
      {
        answer: "a. 내가 사는 세상과 다른 세상을 구경하는 것 같다",
        type: [
          "싱가폴",
          "이집트 사막",
          "보라카이",
    ...
    a: [
      {
        ...
        type: ["이스탄불", "탄자니아 세렝게티", "캐나다 나이아가라 폭포"],
      },
      {
        answer: "b. 날 아무도 모르는 곳에서의 힐링 & 소소한 일탈",
        type: ["프랑스 파리", "태국", "싱가폴", "이집트 사막", "보라카이"],
      },
      {
  ...
  },
  {
    ...
    a: [
      ...
      },
      {
        ...
        type: ["이스탄불", "미국 캘리포니아", "시드니", "스위스"],
      },
      {
        answer: "c. 봤던 곳 또보고 또보는 비효율적인 동선",
        type: ["탄자니아 세렝게티", "태국", "이집트 사막", "영국 런던", "북극"],
      },
    ],
  },
  {
    ...
    a: [
      ...
      },
      {
        ...
        type: ["이스탄불", "미국 캘리포니아", "이집트 사막", "영국 런던"],
      },
      {
        answer:
