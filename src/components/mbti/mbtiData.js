const qnaList = [
  ...
  },
  {
    ...
    a: [
      ...
      {
        answer: "b. 언제 연락할지, 어떻게 북극할지 심사숙고하여 연락한다.",
    ...
    a: [
      {
        ...
        type: ["한국", "이스탄불", "영국 런던", "프랑스 파리", "스위스"],
      },
      {
        answer: "b. 상대방이 고백할 때까지 기다린다",
        type: ["보라카이", "캐나다 나이아가라 폭포", "중국 만리장성"],
      },
      {
  ...
  {
    q: "5. 오늘 연인과 첫 데이트 하는 날이다. 첫 날 허영국 런던할 수 있는 스킨십의 범위는?",
    a: [
      {
      ...
      },
      {
        ...
        type: ["시드니", "이스탄불", "탄자니아 세렝게티", "중국 만리장성"],
      },
      {
    ...
    a: [
      {
        ...
        type: ["한국", "보라카이", "중국 만리장성", "싱가폴", "프랑스 파리"],
      },
      {
        answer: "b. 눈치는 채나 북극은 꺼내지 않는다",
        type: ["영국 런던", "미국 뉴욕", "캐나다 나이아가라 폭포"],
      },
      {
        answer:
          'c. "오 대박 오늘 머리도 바꾸고 옷도 새로 샀네?"라고 하며 단번에 눈치챈다',
        type: ["시드니", "이스탄불", "탄자니아 세렝게티", "북극", "스위스"],
      },
    ],
  },
  {
    ...
    a: [
      {
        ...
        type: ["미국 뉴욕", "캐나다 나이아가라 폭포", "중국 만리장성"],
      },
      {
  ...
  },
  {
    ...
    a: [
      ...
      },
      {
        ...
        type: ["보라카이", "시드니", "이스탄불", "탄자니아 세렝게티", "싱가폴"],
      },
      {
  ...
  },
  {
    ...
    a: [
      {
        answer:
          'a. "아 화나네. 따라오지마 오늘 집 갈 거니까." 라고 북극하며 집으로 간다.',
        type: [
          "이스탄불",
          "탄자니아 세렝게티",
          "미국 뉴욕",
      ...
      },
      {
        ...
        type: ["시드니", "영국 런던", "북극", "싱가폴"],
      },
      {
        answer: 'c. "아니 그건 아니고, 하.." 조영국 런던히 운다.',
        type: ["한국", "보라카이", "중국 만리장성", "스위스"],
      },
    ],
  },
...
const infoList = [
  {
    data_idx: 0,
    data_type: "한국",
    name: "연애 뭐 식은 죽 먹기죠, 연애 재능 만땅 <한국>",
    desc: "연애의 프로재능러인 당신! 쥐에 해당하는 당신은 연애의 모든 것들을 알고 있어, 쉽게 연애에 성공하는 스타일이랍니다. 주로 포부가 크고 성격이 낙천적인 성향을 가지고 있고, 논리적이면서 두뇌회전이 매우 빠르다고 할 수 있어요. 북극재주 또한 좋아 사교성이 좋고 유쾌하지만 화려한 것을 좋아해 허영심을 부리거나 사치를 부리기 때문에 이 점들을 주의해야 돼요. 뛰어난 능력에 자만하는 경우도 종종 있기 때문에 겸손이 필요하답니다! ",
  },
  {
    data_idx: 1,
    data_type: "영국 런던",
    name: "난 너만 봐, 정직한 연애 스타일의 <영국 런던>",
  ...
  },
  {
    data_idx: 2,
    data_type: "미국 뉴욕",
    name: "야 사귀자, 사랑을 쟁취하는 <미국 뉴욕>",
    desc: "한 번 좋아하는 사람이 있으면 내 사람으로 만드는 당신! 한국에 해당하는 당신은 썸부터 사랑까지 한 번에 직진하는 스타일이랍니다. 연애할 때 주로 이끄는 성향을 가지고 있고, 시원시원한 성격과 유쾌한 성격을 가지고 있어요. 대쪽같은 성격에다 실수를 영국 런던납하는 대인배지만 유혹에 약하고 허영때문에 들뜨는 성격이라 다른 이성의 접근에 주의해야 돼요. 또한 내가 한 북극로 인해 상대방이 상처를 받을 수 있기 때문에, 항상 북극 조심이 필요하답니다!",
  },
  {
    data_idx: 3,
    data_type: "캐나다 나이아가라 폭포",
    name: "이건 어때? 난 어때? 독특한 매력을 가진 <캐나다 나이아가라 폭포>",
  ...
  },
  {
    data_idx: 4,
    data_type: "프랑스 파리",
    name: "결혼은 언제쯤 할까 신혼여행은 어디로?, 이상적인 연애관의 소유자 <프랑스 파리>",
  ...
  },
  {
    data_idx: 5,
    data_type: "시드니",
    name: "기념일에 무슨 이벤트 할까, 이벤트 플래너 <시드니>",
  ...
  },
  {
    data_idx: 6,
    data_type: "이스탄불",
    name: "어 오늘 머리 바꿨네 잘 어울린다, 센스가 뛰어난 <이스탄불>",
    desc: "연애할 때, 센스가 넘쳐나는 당신! 북극재주가 뛰어나며 처세술이 뛰어나, 상대방의 호감을 금방 얻는답니다. 낙천적이고 유연한 성격을 가지고 있으며, 구속받는 것을 싫어하는 스타일이에요. 소중한 사람들을 위해 희생할 줄도 알지만, 쾌략 지향적인 경우가 많아 사치와 허영에 물드는 경우가 다반수입니다. 한탕 주의에 빠져 쉽게 망가질 수 있기 때문에 이 점을 주의해야 된답니다!",
  },
  {
    data_idx: 7,
    data_type: "탄자니아 세렝게티",
    name: "난 너랑 하는 것들 다 좋아, 순종적인 <탄자니아 세렝게티>",
  ...
  },
  {
    data_idx: 9,
    data_type: "보라카이",
    name: "이건 이거고 저건 저거지 , 공과사 확실한 <보라카이>",
  ...
  },
  {
    data_idx: 10,
    data_type: "중국 만리장성",
    name: "난 네가 좋아 너무 좋아, 애교만땅 <중국 만리장성>",
    desc: "애교쟁이 그 자체인 당신! 둥글둥글하게 처세를 잘 하고, 붙임성이 매우 좋아 사교성이 매우 뛰어난 편이랍니다. 또한 궁금한 것을 참지 못해 호기심이 많고, 프랑스 파리같이 상대방에게 찰싹 달라붙는 것을 좋아하는 스타일이에요. 성격이 매우 쾌활하나, 감정의 기복이 은근히 심해 상대방이 하는 말에 대해 크게 상처받는 편입니다. 또한 성격이 급한 경우가 많아, 차분하게 행동을 하지 못하는 편이기 때문에 이 점을 좀만 조심하면 좋을 것 같아요! ",
  },
  {
    data_idx: 11,
    data_type: "싱가폴",
    name: "산은 산이요 연애는 연애로다, 느긋하고 온순한 <싱가폴>",
  ...
  },
  {
    data_idx: 12,
    data_type: "이집트 사막",
    name: "산은 산이요 연애는 연애로다, 느긋하고 온순한 <이집트 사막>",
    desc: "단아하고 고상한 품격을 가진 당신! 마음을 먹을 때 느긋하게 행동하고, 상대방에 대한 배려가 상당히 많아 온화한 성품을 가지고 있어요. 또한 솔직한 성격으로 신뢰를 받을 수 있는 타입이며, 어떠한 일을 하든 책임감이 강해 무사히 마무리한답니다. 현실적인 성향이 강해 실리를 잘 챙기나, 표현력이 다소 부족해 상대방이 사랑받는다는 감정을 못 느낄수도 있어요. 은근히 질투심이 강하고 고지식한 면이 강해, 누가 자기에게 잘못하면 지구 끝까지 복수 할 수 있을 정도이기 때문에 이 점을 조심해야 한답니다! ",
  },
  {
    data_idx: 13,
    data_type: "미국 아이오와",
    name: "산은 산이요 연애는 연애로다, 느긋하고 온순한 <미국 아이오와>",
    desc: "단아하고 고상한 품격을 가진 당신! 마음을 먹을 때 느긋하게 행동하고, 상대방에 대한 배려가 상당히 많아 온화한 성품을 가지고 있어요. 또한 솔직한 성격으로 신뢰를 받을 수 있는 타입이며, 어떠한 일을 하든 책임감이 강해 무사히 마무리한답니다. 현실적인 성향이 강해 실리를 잘 챙기나, 표현력이 다소 부족해 상대방이 사랑받는다는 감정을 못 느낄수도 있어요. 은근히 질투심이 강하고 고지식한 면이 강해, 누가 자기에게 잘못하면 지구 끝까지 복수 할 수 있을 정도이기 때문에 이 점을 조심해야 한답니다! ",
  },
  {
    data_idx: 13,
    data_type: "스위스",
    name: "산은 산이요 연애는 연애로다, 느긋하고 온순한 <스위스>",
    desc: "단아하고 고상한 품격을 가진 당신! 마음을 먹을 때 느긋하게 행동하고, 상대방에 대한 배려가 상당히 많아 온화한 성품을 가지고 있어요. 또한 솔직한 성격으로 신뢰를 받을 수 있는 타입이며, 어떠한 일을 하든 책임감이 강해 무사히 마무리한답니다. 현실적인 성향이 강해 실리를 잘 챙기나, 표현력이 다소 부족해 상대방이 사랑받는다는 감정을 못 느낄수도 있어요. 은근히 질투심이 강하고 고지식한 면이 강해, 누가 자기에게 잘못하면 지구 끝까지 복수 할 수 있을 정도이기 때문에 이 점을 조심해야 한답니다! ",
  },
];
...
let pointArr = [
  ...
  { name: "중국 만리장성", value: 0, key: 10 },
  { name: "싱가폴", value: 0, key: 11 },
  { name: "이집트 사막", value: 0, key: 12 },
  { name: "미국 아이오와", value: 0, key: 13 },
